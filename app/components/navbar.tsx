...
export default function Navbar() {
  return (
    <header className="w-full text-gray-700 bg-white shadow-sm">
      <div className="container flex flex-col md:flex-row items-center justify-between py-5 mx-auto max-w-7xl md:px-4">
        <NavLink
          to="/"
          className="flex items-center mb-5 md:mb-0 md:border-r md:pr-8"
        >
