...
export default function Navbar() {
  return (
    <header className="w-full px-2 md:px-4 text-gray-700 bg-white shadow-sm container flex flex-col md:flex-row items-center justify-between py-5 mx-auto max-w-7xl">
      <div className="">
